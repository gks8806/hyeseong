...
body header {
	background: url(/resources/images/moon.jpg) no-repeat 50% 55%;
...
<body>
	...
	<section class="banner_slider">
		<div id="slider" class="nivoSlider">
			<img src="/resources/images/green.jpg" title="슬라이드1" />
		</div>
	</section>
	<section id="contents" class="row">
		<article id="main">
			...
			<ul>
				<li class="clearfix"><img class="col-4"
					src="/resources/images/green.jpg" alt="" width="296" height="206" />
				...
				<li class="clearfix"><img class="col-8 fr last"
					src="/resources/images/green.jpg" alt="" width="620" height="416" />
					<div class="col-4">
		...
		<article id="sub" class="row clearfix">
			...
			<ul>
				<li class="col-3"><img src="/resources/images/green.jpg" alt=""
				...
				<li class="col-6 last"><img src="/resources/images/green.jpg"
