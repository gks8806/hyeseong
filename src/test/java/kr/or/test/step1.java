...
public class step1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("현재 등로된 회원은 " + names.length +" 명 입니다.");
		int[] ages = {45, 100, 3};
		String[] phoneNums = {"000-0000-0000", "111-1111-111", "333-3333-3333"};
		printMember(names, ages, phoneNums);
		
	}
// 같은 이름의 매서드 인데 파라미터(매개변수)가 다르게 만든 매서드를 오버로딩이라고 함.
